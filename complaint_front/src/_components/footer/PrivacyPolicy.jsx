  ...
  return (
    <Container>
      ...
      <Section>
        ...
        <Paragraph>
          이 개인정보 처리방침은 국민신문고 서비스(이하 "서비스")에서 이용자의 개인정보를 어떻게 수집하고, 이용하며, 보호하는지를 안내하는 것을 목적으로 합니다.
        </Paragraph>
      </Section>
      ...
      <Section>
        ...
        <List>
          <ListItem>민원 접수 및 처리: 민원인이 신청한 민원을 관련 부서에 전달하고, 처리 결과를 제공하기 위한 목적</ListItem>
          <ListItem>회원 관리 및 인증: 민원인의 신원 확인, 로그인, 계정 관리 및 비밀번호 복구</ListItem>
          <ListItem>서비스 개선 및 개발: 민원 처리 효율성을 높이고, 서비스 개선 및 이용 통계 분석을 위한 데이터 활용</ListItem>
          <ListItem>법적 의무 이행: 관련 법령 및 정부 지침에 따른 개인정보 제공 요청을 준수하기 위한 목적</ListItem>
        </List>
      </Section>
