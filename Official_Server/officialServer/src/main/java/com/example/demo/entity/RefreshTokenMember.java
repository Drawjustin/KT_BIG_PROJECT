...
@Table(name = "refresh_token_member")
public class RefreshTokenMember {
    ...
    @OneToOne
    @JoinColumn(name = "member_seq", nullable = false, unique = true) // MemberEntity의 PK를 FK로 사용
    private Member member;


    public RefreshTokenMember(Member member, String refreshTokenContent, Date refreshTokenExpiration) {
        this.member = member;
